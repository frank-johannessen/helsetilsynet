...
function RenderView()
{
	...
	document.getElementById('MonthNavigator').innerHTML = '<a class="Link" href="javascript:void(0);" OnClick="RenderMonthMenu();return false;">' + aMonthName[nMonth-1] + '</a>, <a Class="Link" href="javascript:void(0);" OnClick="RenderYearMenu();return false;">' + nYear + '</a>';
...
function onOK()
{
	window.returnValue = FormatDateTime();
	window.close();
}
...
function RenderMonthMenu()
{
	...
	document.getElementById('MonthMenu').style.posLeft	= event.clientX;
	document.getElementById('MonthMenu').style.posTop	= event.clientY;
...
function RenderYearMenu()
{
	...
	document.getElementById('YearMenu').style.posLeft	= event.clientX;
	document.getElementById('YearMenu').style.posTop	= event.clientY;
