...
<%@ Page language="c#" Codebehind="Login.aspx.cs" AutoEventWireup="false" Inherits="EPiServer.Util.Login" %>
							...
							<table width="100%" height="100%" border="0">
								<tr>
									<td class="login" colspan="2">
										...
										<asp:RequiredFieldValidator id="RequiredUsernameValidator" Display="Dynamic" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="Username" /><br>
										<asp:RequiredFieldValidator id="RequiredPasswordValidator" Display="Dynamic" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="Password" />
									</td>
								</tr>
								<tr>
