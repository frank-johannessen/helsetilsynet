<%@ Control Language="c#" AutoEventWireup="false" Codebehind="LinkGenericMail.ascx.cs" Inherits="EPiServer.Util.LinkGenericMail" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<table width="100%" border="0" cellpadding="3" cellspacing="0">
	...
	<tr>
		<td><episerver:translate text="/util/linkeditor/mailfieldcaption" runat="Server"/></td>
