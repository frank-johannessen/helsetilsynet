<%@ Page Codebehind="WsrpHelpPage.aspx.cs" AutoEventWireup="false" Inherits="development.WsrpHelpPage" Language="c#" %>
  ...
  <body>
    ...
    <div id="content">
      ...
      <span visible='<%#ShowingMethodList%>' runat=server>
          ...
          <p class="intro"><%#GetLocalizedText("OperationsIntro", new object[] { EscapedFileName + "?op=WSDL" })%></p>
