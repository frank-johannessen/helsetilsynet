<%@ Control Language="c#" AutoEventWireup="false" Codebehind="CreatePageFramework.ascx.cs" Inherits="EPiServer.Edit.CreatePageFramework" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
			...
			<table CellPadding="0" CellSpacing="0" width="100%" height="100%">
				...
				<tr>
					<td style="padding-left:10px">
						<IFrame src="<%=Configuration.RootDir + Configuration.EditDir + "NewPage.aspx?mode=" + Request["mode"] + "&id=" + Request["id"]%><%=Request.QueryString["epslanguage"] == null ? "" : "&epslanguage=" + Request.QueryString["epslanguage"]%>" Width="100%" Height="100%" Name="EditPanel""></IFrame>
					<td>
				</tr>
			</table>
		</form>
