<%@ Control Language="c#" AutoEventWireup="false" Codebehind="FormPostings.ascx.cs" Inherits="EPiServer.Edit.FormPostings" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<%@ Register TagPrefix="EPiServer" Namespace="EPiServer.WebControls" Assembly="EPiServer" %>
<br />
<table>
	<tr>
		<td>
			<episerver:Translate Text="/edit/editformdata/selectform" runat="server" />
		</td>
		<td>
	...
	<tr>
		<td>
			<episerver:Translate Text="/edit/editformdata/fromdate" runat="server" />
		</td>
		<td>
			<episerver:property id="BeginDate" runat="server" PropertyName="MainForm" />
		</td>
	</tr>
	<tr>
		<td>
			<episerver:Translate Text="/edit/editformdata/todate" runat="server" />
		</td>
		<td>
			<episerver:property id="EndDate" runat="server" PropertyName="MainForm" />
		</td>
	</tr>
	<tr>
		<td>
...
<episerver:formpostings runat="server" id="Statistics" Visible="false" />
<object 
	id="ExcelTools" 
	width="0" 
	height="0" 
