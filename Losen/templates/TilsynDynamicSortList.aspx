<%@ Page language="c#" Codebehind="TilsynDynamicSortList.aspx.cs" AutoEventWireup="false" Inherits="development.TilsynDynamicSortList" %>
<%@ Register TagPrefix="EPiServer" Namespace="EPiServer.WebControls" Assembly="EPiServer" %>
<%@ Register TagPrefix="development" TagName="DefaultFramework"	Src="~/templates/Frameworks/DefaultFramework.ascx"%>
<%@ Register TagPrefix="development" TagName="CategoryList"			Src="~/templates/Units/TilsynDynamicSortList.ascx"%>
