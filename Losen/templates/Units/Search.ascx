...
<div class="noVisibility">
						...
						<FileTemplate>
							...
							<asp:PlaceHolder Runat="server" Visible="<%#!SortDate.Checked%>" ID="Placeholder2">
								<DIV class="link">
									...
									<%#ReturnFileInfo(Container.CurrentPage["PageName"].ToString())%>
		...
		<table border="0" cellpadding="0" cellspacing="0">
								...
								<tr>
										<td valign="bottom" class="content">
		<asp:Repeater ID="rptResultsByCategory" Runat="server">
		<ItemTemplate>
			
				<asp:PlaceHolder Runat="server" Visible="true" ID="Placeholder3">
				<DIV class="link">
				<%#DataBinder.Eval(Container, "DataItem.Image")%>				
				<a href="<%#DataBinder.Eval(Container, "DataItem.LinkURL")%>"><%#DataBinder.Eval(Container, "DataItem.PageName")%></a> (<%#Convert.ToDateTime(DataBinder.Eval(Container, "DataItem.StartPublish")).ToString("d")%>)<br/>
				<%#DataBinder.Eval(Container, "DataItem.PreviewText")%>
