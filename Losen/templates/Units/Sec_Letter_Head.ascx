...
<%@ Control Language="c#" EnableViewState="False" AutoEventWireup="false" Codebehind="Sec_Letter_Head.ascx.cs" Inherits="development.UserControls.Sec_Letter_Head" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<table width="100%" height="168" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td valign="top">
			...
			<div class="<%# (((EPiServer.PageBase)Page).CurrentPage.PageTypeID == Convert.ToInt32(EPiServer.Global.EPConfig["EPsLetterPageTypeID"].ToString()) || ((EPiServer.PageBase)Page).CurrentPage.PageTypeID == Convert.ToInt32(EPiServer.Global.EPConfig["EPsNotePageTypeID"].ToString())) ? "titleTilsyn" : "title" %>">
				<!-- print_start -->
