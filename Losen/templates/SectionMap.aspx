<%@ Page language="c#" Codebehind="SectionMap.aspx.cs" AutoEventWireup="false" Inherits="development.SectionMap" %>
	...
	<EPiServer:Content ID="ContentLatestReport" Region="RegionCenter" runat="server">
		...
		<table width="600" border="0" bordercolor="yellow" cellspacing="0" cellpadding="0" XmlNs:EPiServer="http://schemas.episerver.com/WebControls">
			<tr valign="top">
				...
				<td width="200" class="article" rowspan="2">
					<development:links runat="server"/>
				</td>
			</tr>	
			<tr>
				<td>
					<table width="400" border="0" cellspacing="0" cellpadding="0" class="section">
						<tr valign="top" class="sitemap"> 
							<td class="title"><episerver:property PropertyName="HeadSiteMap" runat="server" ID="Property4" /></td>
						</tr>
						<tr valign="top" class="sitemap">
							<td>
