...
<%@ Register TagPrefix="dev" Namespace="development.Class.MyEPiServer" Assembly="episerversample" %>
...
<html>
	...
	<body>
		...
		<div runat="server" id="TreeContainer">
			<dev:wrappingexplorertree width="100" id="explorerTree" runat="server"></dev:wrappingexplorertree>
		</div>
		</form>
	</body>
</html>