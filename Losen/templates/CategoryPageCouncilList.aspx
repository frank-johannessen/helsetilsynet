<%@ Page language="c#" Codebehind="CategoryPageCouncilList.aspx.cs" AutoEventWireup="false" Inherits="development.CategoryPageCouncilList" %>
<%@ Register TagPrefix="EPiServer" Namespace="EPiServer.WebControls" Assembly="EPiServer" %>
<%@ Register TagPrefix="development" TagName="DefaultFramework"	Src="~/templates/Frameworks/DefaultFramework.ascx"%>
<%@ Register TagPrefix="development" TagName="CategoryList"			Src="~/templates/Units/CategoryCouncilList.ascx"%>
