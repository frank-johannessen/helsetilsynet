<%@ Page language="c#" Codebehind="CategoryPageInstitutionList.aspx.cs" AutoEventWireup="false" Inherits="development.CategoryPageInstitutionList" %>
<%@ Register TagPrefix="EPiServer" Namespace="EPiServer.WebControls" Assembly="EPiServer" %>
<%@ Register TagPrefix="development" TagName="DefaultFramework"	Src="~/templates/Frameworks/DefaultFramework.ascx"%>
<%@ Register TagPrefix="development" TagName="CategoryList"			Src="~/templates/Units/CategoryInstitutionList.ascx"%>
