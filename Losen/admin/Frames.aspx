<%@ Page language="c#" Codebehind="Frames.aspx.cs" AutoEventWireup="false" Inherits="EPiServer.Admin.Frames" %>
  ...
  <body onkeydown="return handleKeyPressed()">
    ...
    <form id="Frames" method="post" runat="server">
		...
		<asp:DataGrid 
			...
			OnEditCommand="EditFrame"
			OnCancelCommand="CancelEditing"
			OnUpdateCommand="SaveFrame"
		...
		>
			<Columns>
				<asp:TemplateColumn>
					...
					<EditItemTemplate>
						<asp:TextBox ID="FrameName" Runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "Name")%>' ></asp:TextBox>
						<asp:RequiredFieldValidator ID="RFV_name" runat="server" ControlToValidate="FrameName">*</asp:RequiredFieldValidator>
					</EditItemTemplate>
				</asp:TemplateColumn>
