...
(function() {
    ...
    var g = {
        ...
        xmlEncode: function(o) { return o ? ("" + o).replace(m, function(p) { return a[p] ? "&" + a[p] + ";" : p; }) : o; },
        toArray: function(q) {
            var p, o = [];
    ...
    g.Uploader = function(r) {
        ...
        g.extend(this, {
            ...
            hasEventListener: function(v) { return !!p[v.toLowerCase()]; },
            bind: function(v, x, w) {
                var y;
                v = v.toLowerCase();
                y = p[v] || [];
            ...
            unbindAll: function() {
                var v = this;
                g.each(p, function(x, w) { v.unbind(w); });
            },
            destroy: function() {
        ...
        init: function(j, l) {
            ...
            j.bind("UploadFile", function(s, p) {
                ...
                function n() {
                    ...
                    c.each(s.settings.headers, function(D, C) { z.setRequestHeader(C, D); });
...
(function(g, b, d, e) {
    ...
    d.runtimes.Silverlight = d.addRuntime("silverlight", {
        getFeatures: function() { return { jpgresize: true, pngresize: true, chunks: true, progress: true, multipart: true, multi_selection: true }; },
        init: function(p, q) {
            ...
            p.bind("Silverlight:Init", function() {
                ...
                p.bind("Silverlight:UploadChunkError", function(t, w, u, x, v) { p.trigger("Error", { code: d.IO_ERROR, message: "IO Error.", details: v, file: t.getFile(s[w]) }); });
    ...
    d.runtimes.Flash = d.addRuntime("flash", {
        ...
        init: function(n, p) {
            ...
            n.bind("Flash:Init", function() {
                ...
                n.bind("Flash:SecurityError", function(s, t) { n.trigger("Error", { code: d.SECURITY_ERROR, message: d.translate("Security error."), details: t.message, file: n.getFile(r[t.id]) }); });
                n.bind("Flash:GenericError", function(s, t) { n.trigger("Error", { code: d.GENERIC_ERROR, message: d.translate("Generic error."), details: t.message, file: n.getFile(r[t.id]) }); });
                n.bind("Flash:IOError", function(s, t) { n.trigger("Error", { code: d.IO_ERROR, message: d.translate("IO error."), details: t.message, file: n.getFile(r[t.id]) }); });
                n.bind("Flash:ImageError", function(s, t) { n.trigger("Error", { code: parseInt(t.code, 10), message: d.translate("Image error."), file: n.getFile(r[t.id]) }); });
                ...
                n.bind("Flash:StageEvent:mouseDown", function(s) {
                    ...
                    if (t && u) {
                        d.addClass(t, u);
                        d.addEvent(b.body, "mouseup", function() { d.removeClass(t, u); }, s.id);
                    }
                });
                ...
                n.bind("Flash:ExifData", function(s, t) { n.trigger("ExifData", n.getFile(r[t.id]), t.data); });
                n.bind("Flash:GpsData", function(s, t) { n.trigger("GpsData", n.getFile(r[t.id]), t.data); });
                n.bind("QueueChanged", function(s) { n.refresh(); });
                ...
                n.bind("StateChanged", function(s) { n.refresh(); });
...
(function(d, a, b, c) {
    ...
    b.runtimes.Html4 = b.addRuntime("html4", {
        getFeatures: function() { return { multipart: true, triggerDialog: (b.ua.gecko && d.FormData || b.ua.webkit) }; },
        init: function(f, g) {
