...
namespace MakingWaves.Helsetilsynet.Intranet.Web.CustomProperties.PropertyUserPickerControl
{
    public class PropertyUserPickerControl : PropertyTextBoxControlBase
    {
        ...
        public override void CreateEditControls()
        {
            ...
            hfUsers.ID = "hfUsers";
            hfUsers.ClientIDMode = ClientIDMode.Static;
            ...
            btn.Attributes.Add("onclick", "OpenDialogUserAndGroupBrowser(0, '', '" + UriSupport.AbsoluteUrlFromUIBySettings("edit") + "', true, HtUserDialogCompleted, document.getElementById('" + this.hfUsers.ClientID + "'), null);");
