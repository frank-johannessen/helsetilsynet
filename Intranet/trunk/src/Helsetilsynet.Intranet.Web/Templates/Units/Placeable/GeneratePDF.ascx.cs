...
{
    public partial class GeneratePDF : RelateUserControlBase<Model.BasePage>
    {
        ///
        ...
        protected void GetPDF(object sender, EventArgs eventArgs)
        {
            ...
            else // no cached version
            {
                ...
                try
                {
                    ...
                    if(PageToConvert is LargeDocument)
        ...
        {
            return Path.Combine(
                ConfigurationManager.AppSettings[GlobalName.AppSettings.PdfConverterTempfiles], 
                page.PageName + ".pdf");
        }
        ...
        {
            pdfConverter.LicenseKey = ConfigurationManager.AppSettings[GlobalName.AppSettings.PdfConverterLicenseKey];
 ...
 */       
        ...
        */
        ...
        {
            var pdfRendererPage = DataFactory.Instance.GetPage(CurrentPage.GlobalSettings.PdfRenderer);
            var friendlyURL = ExtensionMethods.FriendlyURL.GetFriendlyURL(pdfRendererPage, true); var separator = friendlyURL.Contains("?") ? "&" : "?";
