...
namespace Helsetilsynet.CustomProperties.PropertyUserPickerControl
{
    public class PropertySingleUserPickerControl : PropertyTextBoxControlBase
    {
        ...
        public override void CreateEditControls()
        {
            ...
            btn.Attributes.Add("onclick", "OpenDialogUserAndGroupBrowser(0, '', '" + UriSupport.AbsoluteUrlFromUIBySettings("edit") + "', false, HtUserDialogCompleted, document.getElementById('" + _hfUsers.ClientID + "'), null);");
            ...
            script.Append("EPi.PageLeaveCheck.SetPageChanged(true)");
            script.Append("}");
            script.Append("//-->\n");
