    ...
    public partial class News : UserControlBase
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (CurrentPage["NewsRoot"] != null)
                {
                    epiPageList.PageLink = (PageReference)CurrentPage["NewsRoot"];
                }
        ...
        {
            return page.Created.ToString(format);
        ...
        protected string GetPreviewText(PageData page)
        {
            ...
            {
                string s = StripPreviewText(page.Property["MainIntro"].ToWebString(), PreviewTextLength);
                return TextIndexer.StripHtml(s, PreviewTextLength);
            }
