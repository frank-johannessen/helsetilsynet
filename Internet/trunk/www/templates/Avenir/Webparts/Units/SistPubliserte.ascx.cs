...
{
    public partial class SistPubliserte : EPiCode.WebParts.UserControlWebPartBase
    {
        private PropertyPageReference _listingContainer = new PropertyPageReference();
        private PropertyString _menuGroup = new PropertyString();
        ...
        [Personalizable]
        [WebDisplayName("Menygruppe som det skal søkes fra ")]
        public PropertyString MenuGroup
        {
        ...
        [Personalizable]
        [WebDisplayName("Max ant. artikler i listen ")]
        ...
        [WebDisplayName("Link til nyhetsarkiv")]
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            ChangedPages.MenuGroup = getGroup();
        }
        ...
        protected string getAlleSakerLink()
        {
