...
namespace Avenir.Templates.Pages
{
	...
	/// </summary>
    public partial class BoxListing : EPiCode.WebParts.TemplatePageWebPartBase // TemplatePage
	{
        ...
        //        s += p.Property["Forskrifter"].ToString()+"</div>";
        //    }
        ...
        //        s += p.Property["Rundskriv"].ToString() + "</div>";
        //    }
